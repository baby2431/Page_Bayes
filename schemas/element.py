...
class Element(HtmlElement):
    _id: int = None
    _selector: str = None
    _selector_short: str = None
    _parent_selector: str = None
    _alias: str = None
    _alias_short: str = None
    _tag_name: str = None
    _path: str = None
    _path_raw: str = None
    _children = None
    ...
    def alias_short(self):
        ...
        :return: string
        """
        if self._alias_short is not None:
            return self._alias_short
        from gerapy_auto_extractor.utils.element import alias
        self._alias_short = alias(self,True)
        return self._alias_short
    ...
    @property
    def selector_short(self):
        """
        get id by hashed element
        :return:
        """
        if self._selector_short is not None:
            return self._selector_short
        from gerapy_auto_extractor.utils.element import selector
        self._selector_short = selector(self, True)
        return self._selector_short
    ...
    def path_nth(self):
        """
        no invalid describe => get tag path using external path function with tag position xpath describe
        :return:
        """
        from gerapy_auto_extractor.utils.element import path_position
        return path_position(self)
